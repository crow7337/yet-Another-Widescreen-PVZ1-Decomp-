...
ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {  //0x69DA80
    ...
    { ZOMBIE_NEWSPAPER,         REANIM_ZOMBIE_NEWSPAPER,    2,      3,     1,      1000,   _S("NEWSPAPER_ZOMBIE") },
    ...
    { ZOMBIE_IMP,               REANIM_IMP,                 1,      1,      1,      4000,      _S("IMP") },
    ...
    { ZOMBIE_SQUASH_HEAD,       REANIM_ZOMBIE,              3,      99,     10,     2000,   _S("ZOMBIE"),1 },
    { ZOMBIE_TALLNUT_HEAD,      REANIM_ZOMBIE,              4,      99,     10,     2000,   _S("ZOMBIE"),1 },
    ...
    if (HasYuckyFaceImage())
    {
        ...
        else if (mHasHead)
        {
            ...
            if (mVariant)
            {
                ...
                aBodyReanim->AssignRenderGroupToTrack("Zombie_mustache", RENDER_GROUP_NORMAL);
            }
        }
    }
}
