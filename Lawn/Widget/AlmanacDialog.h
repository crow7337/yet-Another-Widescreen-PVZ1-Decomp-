...
constexpr const float			ALMANAC_PLANT_POSITION_X		= 970.0f;
constexpr const float			ALMANAC_PLANT_POSITION_Y		= 176.0f;
constexpr const float			ALMANAC_ZOMBIE_POSITION_X		= 970.0f;
constexpr const float			ALMANAC_ZOMBIE_POSITION_Y		= 206.0f;
constexpr const int				ALMANAC_INDEXPLANT_POSITION_X	= 399;
constexpr const int				ALMANAC_INDEXPLANT_POSITION_Y	= 305;
constexpr const float			ALMANAC_INDEXZOMBIE_POSITION_X	= 780.0f;
constexpr const float			ALMANAC_INDEXZOMBIE_POSITION_Y	= 285.0f;
