...
public:
	...
	Reanimation*                    CreateBushReanim(int theRenderOrder);
	...
	Reanimation*                    CreateBushReanim(float theX, float theY, int theRenderOrder, ReanimationType theReanimationType);
	bool                            BackgroundHasBush();
	void                            RustleBush(int theRow);
};
